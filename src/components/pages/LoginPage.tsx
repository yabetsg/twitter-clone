    ...
    return(
        ...
        <div className="flex text-[rgb(231,233,234)] items-center bg-gray-700 sm:h-screen max-sm:bg-black max-[300px]:w-80 max-sm:w-screen  max-sm:h-screen w-screen">
            ...
            <form className="flex flex-col items-center max-w-[364px] min-h-[400px] gap-6">
                ...
                <div>Dont have an account? <span><a href="" onClick={handleAuthentication} className="text-sm text-blue-400">Sign up</a></span></div>
            </form>
        </div>
        </div>
        :
        <div className="flex text-[rgb(231,233,234)] items-center bg-gray-700 sm:h-screen max-sm:bg-black max-[300px]:w-80 max-sm:w-screen  max-sm:h-screen w-screen">
            ...
            <form className="flex flex-col items-center max-w-[364px] min-h-[400px] gap-6">
                ...
                <button type="submit" className="min-w-[300px] font-normal text-sm flex justify-center items-center gap-2 text-black bg-white rounded-2xl h-9"><span className=""><img className="w-5 h-5" src={googleicon} alt="" /></span>Sign up with Google</button>
                <div className="flex justify-center w-full gap-2"><span className="self-center w-full h-[1px] bg-gray-600"></span>or<span className="self-center w-full h-[1px] bg-gray-600"></span></div>
                ...
                <button type="submit" className="text-black bg-white rounded-2xl min-h-[40px]  min-w-[300px] font-semibold">Sign up</button>
                <div>Have an account already? <span><a href="" onClick={handleAuthentication} className="text-sm text-blue-400">Sign in</a></span></div>
            </form>
        </div>
        </div>
