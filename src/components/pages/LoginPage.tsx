      ...
      <div className="flex flex-col items-center text-white bg-black  rounded-xl  w-[600px] max-w-[80vw] mx-auto justify-center min-h-[400px] max-h-[90vh] h-[600px]">
        ...
        <form className="flex flex-col items-center max-w-[364px] min-h-[400px] gap-6">
          ...
          <button
            ...
            type="submit"
            className="min-w-[300px] font-normal text-sm flex justify-center items-center gap-2 text-black bg-white rounded-2xl h-9"
          >
            <span className="">
          ...
          <div className="flex justify-center w-full gap-2">
            <span className="self-center w-full h-[1px] bg-gray-600"></span>or
            <span className="self-center w-full h-[1px] bg-gray-600"></span>
          </div>
          <input
            type="text"
            className="bg-black box-border outline-none focus:border-blue-500 focus:border-2 border-2 p-3 min-h-[40px] border-gray-600 min-w-[300px] rounded-md"
            placeholder="Username"
          />
          <input
            type="password"
            className="bg-black outline-none focus:border-blue-500 focus:border-2 border-2 p-3 min-h-[40px] border-gray-600 min-w-[300px] rounded-md "
            placeholder="Password"
          />
          <button
            type="submit"
            className="text-black bg-white rounded-2xl min-h-[40px]  min-w-[300px] font-semibold"
          >
            Log in
          </button>
          <div>
